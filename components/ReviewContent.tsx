...
export default function ReviewContent() {
    ...
    const handleUpdate = (e: React.FormEvent) => {
        e.preventDefault();
        const id = words[currentIndex].id;
        updateWord(id, { word: wordInput, meaning: meaningInput });
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 md:p-12 w-full max-w-7xl mx-auto bg-white overflow-hidden">
            <div className="w-full max-w-xl mb-6 md:mb-12 flex justify-between items-center bg-slate-50 p-4 md:p-6 rounded-3xl md:rounded-[2.5rem] border border-slate-100/50">
